...
class Autorole(commands.Cog):
    ...
    async def autorole(self, ctx, *, reason = None):
        ...
        if reason == None:
            ...
            embed = discord.Embed(title="Reaction Role", description="Si vous souhaitez accéder à certains channels communautaires, il vous faut réagir avec la réaction qui va avec le channel !", color=discord.Color.from_rgb(17, 100, 20))
